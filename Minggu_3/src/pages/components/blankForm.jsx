...
export default function BlankForm({register, handleSubmit, errors, inputStatus, setInputStatus, experiences, setExperiences, generate, statusChange, addField, deleteField, changeTitle, changePlace, changeDesc, changeStart, changeEnd}) {
    return (
        <>
