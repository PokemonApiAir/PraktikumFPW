                    ...
                    <div className="w-11/12 bg-white flex flex-col justify-center items-center rounded-lg mt-12 gap-y-5 py-10">
                        <div className='w-full flex justify-around h-16'>
                            <div className='w-1/2 flex flex-col mx-12 h-full'>
                                ...
                                })} type="text" id="" placeholder='Nama' defaultValue={data.nama}/>
                            ...
                            <div  className='w-1/2 flex flex-col mx-12 h-full'>
                                ...
                                })} type="text" id="" placeholder='Title' defaultValue={data.title}/>
                        ...
                        <div className='w-full flex justify-around h-16'>
                            <div className='w-1/2 flex flex-col mx-12 h-full'>
                                ...
                                })} type="text" id=""  placeholder='Phone Number' defaultValue={data.phone_number}/>
                            ...
                            <div className='w-1/2 flex flex-col mx-12 h-full'>
                                ...
                                })} type="text" id=""  placeholder='Email' defaultValue={data.email}/>
                        ...
                        <div className='w-full flex justify-around h-16'>
                            <div className='w-1/2 flex flex-col mx-12 h-full'>
                                ...
                                })} type="text" id=""  placeholder='Domicile' defaultValue={data.domicile}/>
                            ...
                            <div className='w-1/2 flex flex-col mx-12 h-full'>
                                ...
                                })} type="text" id=""  placeholder='Linkedin ID' defaultValue={data.linkedin}/>
                        ...
                        <div className='w-full flex flex-col justify-around h-16'>
                            <div className='w-full flex flex-col px-12 h-full'>
                                ...
                                })} type="text" id=""  placeholder='Photo URL' defaultValue={data.photo_url}/>
