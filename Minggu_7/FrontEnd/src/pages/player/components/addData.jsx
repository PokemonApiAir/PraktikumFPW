    ...
    return (
        <>
            <div className="w-full h-full flex flex-col justify-center items-center">
                <h1 className='text-5xl font-bold mt-24'>Add Player</h1>
                <Form action={`/player/add`} method="POST" className="w-2/6 h-96 bg-gray-200 flex flex-col items-center px-12 mt-24 rounded-xl">
